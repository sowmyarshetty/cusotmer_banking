...
def main():
    ...
    # ADD YOUR CODE HERE
    print(f"Interest Earned on Savings account is {interest_earned} and updated savings account balance is {updated_savings_balance}")
    ...
    # ADD YOUR CODE HERE
    print(f"Interest Earned on CD account is {interest_earned:,.2f} and updated savings account balance is {updated_cd_balance:,.2f}")
